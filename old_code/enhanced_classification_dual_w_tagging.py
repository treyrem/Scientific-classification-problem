...
class EnhancedLLMClassifier:
    ...
    def tag_product(
        ...
        """Complete tagging with all 4 categories including specimen tags"""
    ...
    def _validate_tags(self, result: Dict[str, Any]) -> Dict[str, Any]:
        """Validate ALL 4 tag categories including specimen"""
...
def process_enhanced_validation_sample():
    ...
    try:
        ...
        return [
            # Basic product info (existing)
            # "Name", "Description", "Manufacturer" - these come from input CSV
